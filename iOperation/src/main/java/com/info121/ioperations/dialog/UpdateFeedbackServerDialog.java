...
import com.info121.ioperations.fragment.FeedbackFragment;
...
public class UpdateFeedbackServerDialog extends Dialog {

	private static UpdateFeedbackServerDialog error = null;
	...
	protected UpdateFeedbackServerDialog(final Context context, final Activity act,final FeedbackFragment fragment, boolean isVisible) {
	...
	public static void show(Context context, Activity act, FeedbackFragment fragment, boolean isVisible) {
		error = new UpdateFeedbackServerDialog(context, act,fragment,isVisible);
		error.show();
	}
