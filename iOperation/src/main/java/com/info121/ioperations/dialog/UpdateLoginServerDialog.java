...
public class UpdateLoginServerDialog extends Dialog {

	private static UpdateLoginServerDialog error = null;
	...
	protected UpdateLoginServerDialog(final Context context, final Activity act, boolean isVisible) {
		...
		((EditText)findViewById(R.id.EditTextUpdateServerPassword)).setText("KJyN33EwZc");
...
//			    ChooseTaskActivity.thisFragment.finish();
	...
	public static void show(Context context, Activity act, boolean isVisible) {
		error = new UpdateLoginServerDialog(context, act,isVisible);
		error.show();
	}
